          ...
          <div class="card h-100">
              ...
              <div class="card-footer">
                  <div class="row align-items-center justify-content-between">
                      ...
                      <div class="col-auto">
                          <a href="speaker-details.html?id=${speaker.id}" class="btn btn-primary">Read full bio</a>
                      </div>
                  </div>
              </div>
          </div>
  ...
  return `
      <div class="row">
          ...
          <div class="col-12 col-lg-6">
              ...
              <div class="col-auto">
                  <a href="/agenda.html#presenters" class="btn btn-primary">View all presenters</a>
              </div>
          </div>
          </div>
      </div>
